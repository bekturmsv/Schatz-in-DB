...
public interface UserSolutionRepository extends JpaRepository<UserSolution, Long> {
    ...
    List<UserSolution> findTop3ByUserIdAndCorrectTrueOrderBySubmittedAtDesc(Long userId);
    long countByUserIdAndCorrectTrueAndTaskCodeIn(Long userId, Collection<String> taskCodes);
}